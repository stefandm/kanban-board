                        ...
                        >
                          {(provided, snapshot) => (
                            <li
                              ...
                              className={`flex flex-col justify-between bg-white p-4 rounded-lg shadow-[0_3px_10px_rgb(0,0,0,0.2)] mb-4  ${
                            ...
                            >
                              ...
                              <div className="flex justify-between items-center sm:mt-4">
                                ...
                                <div className="flex space-x-2">
                                  ...
                                  >
                                    <RiEdit2Fill  size={30} aria-hidden="true" className='md:scale-125'/>
                                  ...
                                  >
                                    <IoMdTrash size={25} aria-hidden="true" className='md:scale-125'/>
                                  </button>
                                </div>
                              </div>
                            </li>
