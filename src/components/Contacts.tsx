            ...
            <div className="bg-white">
              {contacts.map((contact) => (
                <button
                  ...
                  className="group bg-white mx-8 my-6 py-2 pl-12 border-b-2 rounded-t-xl border-gray-500 flex justify-between items-center cursor-pointer hover:bg-gray-700 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500"
                  aria-label={`Edit contact ${contact.name}`}
                >
                  <div
                    className="w-12 h-12 rounded-full bg-blue-600 group-hover:bg-blue-400 flex items-center justify-center text-white font-bold mr-4"
                    aria-hidden="true"
                  >
